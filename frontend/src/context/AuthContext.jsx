...
// sessionStorage depending on "remember me", and (2) on mount, re-validate
// a stored token against the gateway's /auth/me (a token existing locally
// doesn't mean it's still valid server-side). Also registers this context's
