...
import { defaultRingColors, RingProvider, ringCssVars } from "./ring-context";
...
function isRing(child) {
  ...
  typeof child.type === "function" && ((child.type).displayName === "Ring" || (child.type).name === "Ring"));
}

// Helper to check if a child is a RingCenter component
function isRingCenter(child) {
  return (isValidElement(child) &&
  typeof child.type === "function" && ((child.type).displayName === "RingCenter" || child.type.name === "RingCenter"));
}
